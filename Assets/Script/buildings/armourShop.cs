...
{
    public static armourShop Instance;
    ...
    void Start()
    {
        ...
        player.OnArmourStoreUpgrade += Player_OnArmourStoreUpgrade;
        LoadBuildingLevel();
    ...
    private void Player_OnArmourStoreUpgrade(object sender, System.EventArgs e)
    {
        UpgradeBuilding();
        ...
        if (buildingLevel < levelSprites.Length && buildingLevel < 3)
        {
          currentUpgradeCost  = upgradeCosts[buildingLevel];
            ...
            else
            {
                ...
                cost.text = " Not Eought Coins to Upgrade";
            }
        }
        else
        {
    ...
    public void Show()
    {
        ...
        cost.text = " WindMill Upgrade Cost = " + currentUpgradeCost + " Upgrade to Increase Happiness Level of Villagers";
